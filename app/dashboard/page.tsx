            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className="flex items-center justify-center mt-1">
                  ...
                  <TrendingUp className="text-green-600 w-6 h-6 ml-1" />
                </div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-gray-900">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="space-y-2">
              {recent.map((product, key) => {
                ...
                const bgColors = ["bg-red-600", "bg-amber-600", "bg-green-600"];
                const textColors = [
                  "text-red-600",
                  "text-amber-600",
                  "text-green-600",
                ...
                return (
                  <div
                    key={key}
                    className="flex items-center justify-between bg-gray-100 px-3 py-3 rounded"
                  >
                    ...
                    <div
                      className={`${textColors[stockLevel]} font-semibold font-mono text-xs`}
                    >
